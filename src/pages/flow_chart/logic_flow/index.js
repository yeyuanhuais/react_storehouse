...
import { Menu, DndPanel, SelectionSelect, Control, MiniMap, InsertNodeInPolyline } from "@logicflow/extension";
import LogicFlow from "@logicflow/core";
import "@logicflow/core/dist/style/index.css";
import "@logicflow/extension/lib/style/index.css";
import BpmnIo from "./comps/bpmn_io";
import BpmnPattern from "./comps/bpmn_pattern";
export default () => {
  ...
  useEffect(() => {
    setLogicflow(
      new LogicFlow({
        ...
        height: height - 150,
        // 注册组件
        plugins: [Menu, DndPanel, SelectionSelect, Control, MiniMap, InsertNodeInPolyline],
      })
    );
  }, [height, width]);
  useEffect(() => {
    if (logicflow) {
      ...
      logicflow.extension.control.addItem({
        iconClass: styles["custom-minimap"],
        title: "",
        text: "导航",
        onMouseEnter: (lf, ev) => {
  ...
  return (
    <div className={styles.logic}>
      <div ref={refContainer} style={{ width: "100%" }}></div>
      <BpmnIo lf={logicflow} />
      {/* <BpmnPattern lf={logicflow} /> */}
    </div>
  );
};
